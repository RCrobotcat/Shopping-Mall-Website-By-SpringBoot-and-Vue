<template>
  <div>
    <div class="search">
      <el-input placeholder="根据评论内容查询" style="width: 200px" v-model="content"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" stripe @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="userName" label="评论用户" :show-overflow-tooltip="true"></el-table-column>
